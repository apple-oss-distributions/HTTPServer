             ...
             options:(DDLogMessageOptions)optionsMask
{
	if ((self = [super init]))
	{
		...
		__weak dispatch_queue_t q = dispatch_get_current_queue();
		const char *label = q ? dispatch_queue_get_label(q) : "defunct";
		queueLabel = dd_str_copy(label);
...
/* see DDLog.h */
dispatch_queue_t get_current_dispatch_queue(void)
{
#undef dispatch_get_current_queue
