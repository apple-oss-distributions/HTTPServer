...
#define HTTPLogTaggedError(tag, frmt, ...)		LOG_OBJC_TAG_MAYBE(HTTP_LOG_ASYNC_ERROR,   httpLogLevel, HTTP_LOG_FLAG_ERROR,  \
																   HTTP_LOG_CONTEXT, tag, frmt, ##__VA_ARGS__)
#define HTTPLogTaggedWarn(tag, frmt, ...)		LOG_OBJC_TAG_MAYBE(HTTP_LOG_ASYNC_WARN,    httpLogLevel, HTTP_LOG_FLAG_WARN,   \
																   HTTP_LOG_CONTEXT, tag, frmt, ##__VA_ARGS__)
#define HTTPLogTaggedInfo(tag, frmt, ...)		LOG_OBJC_TAG_MAYBE(HTTP_LOG_ASYNC_INFO,    httpLogLevel, HTTP_LOG_FLAG_INFO,    \
																   HTTP_LOG_CONTEXT, tag, frmt, ##__VA_ARGS__)
#define HTTPLogTaggedVerbose(tag, frmt, ...)	LOG_OBJC_TAG_MAYBE(HTTP_LOG_ASYNC_VERBOSE, httpLogLevel, HTTP_LOG_FLAG_VERBOSE, \
																   HTTP_LOG_CONTEXT, tag, frmt, ##__VA_ARGS__)
#define HTTPLogTaggedTrace(tag)					LOG_OBJC_TAG_MAYBE(HTTP_LOG_ASYNC_TRACE,   httpLogLevel, HTTP_LOG_FLAG_TRACE, \
																   HTTP_LOG_CONTEXT, tag, @"%@[%p]: %@", THIS_FILE, self, THIS_METHOD)
#define HTTPLogTaggedTrace2(tag, frmt, ...)		LOG_OBJC_TAG_MAYBE(HTTP_LOG_ASYNC_TRACE,   httpLogLevel, HTTP_LOG_FLAG_TRACE, \
																   HTTP_LOG_CONTEXT, tag, frmt, ##__VA_ARGS__)
...
#define HTTPLogCTrace()               LOG_C_MAYBE(HTTP_LOG_ASYNC_TRACE,   httpLogLevel, HTTP_LOG_FLAG_TRACE, \
                                                  HTTP_LOG_CONTEXT, @"%@: %s", THIS_FILE, __FUNCTION__)
